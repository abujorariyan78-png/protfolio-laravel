...
<html lang="en">
    ...
    <body id="page-top">
        ...
        {{-- {{ dd($main->bg_img); }} --}}
        <!-- Masthead-->
        <header class="masthead" style="background-image: url('{{ asset( $main->bg_img) }}')" >
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    @foreach ($service as $service )
                        <div class="col-md-4">
                        <span class="fa-stack fa-4x" style="background: yellow; border-radius:50%;color:white; ">
                ...
                <div class="row">
                    ...
                    @foreach ($protfolio as $protfolio )
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1 {{ $protfolio->id }}">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class=" img-fluid text-"  src="{{url($protfolio->small_image)}}" alt="..." />
                            </a>
        ...
        <!-- Contact-->
          <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" action="{{route('contact.stor')}}" method="POST">
                    @csrf
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="{{asset($protfolio->big_image) }}" alt="..." />
                                    <p>{{$protfolio->descritption}}</p>
